...
from moudels.mpaunet import cascade
    ...
    if args.benchmark:
        ...
        if args.tb_logs:
            logger = TensorBoardLogger(
                ...
                name=f"version={args.ckpt_name}_task={args.task}_dim={args.dim}_fold={args.fold}_precision={16 if args.amp else 32}",

...
def get_main_args(strings=None):
    ...
    arg(
        "--exec_mode",
        type=str,
        choices=["train", "evaluate", "predict","predict_kflod"],
        default="train",
        help="Execution cascade_moudels to run the model",
    )
    arg("--ckpt_name", type=str, default=None, help="Path for loading checkpoint")
    arg("--data", type=str, default="/home/user/4TB/Chenbonian/medic-segmention/BraTS_dataset/15_3d", help="Path to data directory")
    # arg("--data", type=str, default="/home/user/4TB/Chenbonian/medic-segmention/BraTS_dataset/14_3d/test", help="Path to data directory")
    # arg("--results", type=str, default="/home/user/4TB/Chenbonian/medic-segmention/BraTS2023_results", help="Path to results directory")
    arg("--results", type=str, default="/home/user/4TB/Chenbonian/medic-segmention/isnet/",help="Path to results directory")
    #
    # arg("--ckpt_path", type=str,
    #     default="/home/user/4TB/Chenbonian/medic-segmention/BraTS2023_ckpt/checkpoints/last-v3.ckpt", help="Path for loading checkpoint")
    # arg("--ckpt_path", type=str,
    #     default="/home/user/4TB/Chenbonian/medic-segmention/isnet/checkpoints/epoch=609-dice=89.36.ckpt", help="Path for loading checkpoint")
    #arg("--ckpt_path", type=str,
     #   default="/home/user/4TB/Chenbonian/medic-segmention/isnet/checkpoints/last-v59.ckpt", help="Path for loading checkpoint")
    arg("--ckpt_path", type=str,default=None,help="Path for loading checkpoint")
    # python main.py --gpus 1 --amp --save_preds --exec_mode predict --tta --fold 0 --brats

    arg("--ckpt_store_dir", type=str, default="/home/user/4TB/Chenbonian/medic-segmention/isnet/", help="Path for saving checkpoint")
    # arg("--ckpt_store_dir", type=str, default="/home/user/4TB/Chenbonian/medic-segmention/BraTS2023_ckpt/",
    #     help="Path for saving checkpoint")
    arg("--task", type=str, default="15", help="Task number. MSD uses numbers 01-10")
    ...
    arg("--seed", type=non_negative_int, default=3407, help="Random seed")
    ...
    arg("--batch_size", type=positive_int, default=4, help="Batch size")
    ...
    arg("--depth", type=non_negative_int, default=6, help="The depth of the encoder")
    ...
    arg(
        ...
        default=0,
        help="Limit number of batches for training (used for benchmarking cascade_moudels only)",
    )
    arg(
        "--test_batches",
        type=non_negative_int,
        default=0,
        help="Limit number of batches for inference (used for benchmarking cascade_moudels only)",
    )

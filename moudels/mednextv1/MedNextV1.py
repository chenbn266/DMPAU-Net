...
from moudels.mednextv1.blocks import *
...
class MedNeXt(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.do_ds and self.training:
            x_ds_1=F.interpolate(x_ds_1, x.shape[2:], mode='trilinear')
            x_ds_2 = F.interpolate(x_ds_2, x.shape[2:], mode='trilinear')
            x_ds_3 = F.interpolate(x_ds_3, x.shape[2:], mode='trilinear')
            x_ds_4 = F.interpolate(x_ds_4, x.shape[2:], mode='trilinear')
            out_all = [x, x_ds_1, x_ds_2, x_ds_3, x_ds_4]
